        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('admin/coupons/update/' . $coupon['id']) ?>" method="post">
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="minimum_amount" name="minimum_amount" 
                                               value="<?= old('minimum_amount', $coupon['minimum_amount']) ?>" step="0.01" min="0">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="maximum_discount" name="maximum_discount" 
                                               value="<?= old('maximum_discount', $coupon['maximum_discount']) ?>" step="0.01" min="0">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="start_date" name="start_date" 
                                           value="<?= old('start_date', date('Y-m-d\TH:i', strtotime($coupon['start_date']))) ?>" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="end_date" name="end_date" 
                                           value="<?= old('end_date', date('Y-m-d\TH:i', strtotime($coupon['end_date']))) ?>" required>
                                ...
                                <div class="mb-3">
                                    <div class="alert alert-info">
                                        ...
                                        <?php if ($coupon['usage_limit']): ?>
                                            (<?= round(($coupon['used_count'] / $coupon['usage_limit']) * 100, 1) ?>% of limit)
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
