                            ...
                            <div class="order-items">
                                <?php foreach ($cart as $item): ?>
                                    <div class="order-item">
                                        <div class="item-info">
                                            <h5 class="product-name"><?= esc($item['product_name']) ?></h5>
...
/* Increase font sizes for totals section */
.total-row {
...
/* Increase font sizes for form labels and inputs */
.form-label {
    font-size: 1.1rem !important;
    font-weight: 600 !important;
    margin-bottom: 0.5rem !important;
...
/* Increase font sizes for buttons */
.btn {
    font-size: 1rem !important;
...
/* Increase font sizes for customer info section */
.customer-info h5 {
    font-size: 1.3rem !important;
    font-weight: 600 !important;
    margin-bottom: 1rem !important;
